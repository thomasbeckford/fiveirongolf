...
export default async function Home() {
  ...
  return (
    <div className="flex flex-col gap-16">
      <div className="bg-fiveiron-tangerine p-6 md:p-12">
        <HighImpactHero backgroundType="video" backgroundSrc="/videos/world.mp4" overlayOpacity={0.5}>
      ...
      <section className="w-full flex flex-col md:flex-row gap-4 md:gap-0 md:px-12 text-center md:text-left justify-between max-w-7xl mx-auto items-center ">
        <Image src="/itsallgood.svg" alt="Logo" width={480} height={220} />
        <p className="text-lg max-w-xl">
          We’re blurring the lines between indoor golf and entertainment. State-of-the-art simulators and world-class
          instruction meet premium events and amenities plus delectable food and cocktail menus. Five Iron is fostering
